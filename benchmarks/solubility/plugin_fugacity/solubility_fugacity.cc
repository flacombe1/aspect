...
namespace aspect
{
  namespace MaterialModel
  {
                             ...
                             typename Interface<dim>::MaterialModelOutputs &out) const
    {
      ...
      const unsigned int water_idx = this->introspection().compositional_index_for_name("bound_fluid");
      ...
      for (unsigned int q=0; q<in.temperature.size(); ++q)
        {
          ...
          // which is the sum free and bound water, i.e. porosity + bound_fluid.
